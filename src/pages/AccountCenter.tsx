...
import { Copy, LogOut, ShoppingCart, X } from "lucide-react";
  ...
  return (
    <AppPageShell currentPath="/menu" showHeader={false} backgroundImage={shellBackgrounds.accountCenter}>
      ...
      >
          ...
          >
            ...
            <div className="min-w-0 flex-1 space-y-3 sm:space-y-4">
              ...
              <Button
                ...
                className="ml-2 mt-3 bg-red-700/90 hover:bg-red-600"
              >
        ...
        <div className={`flex flex-wrap justify-center gap-3 rounded-3xl border border-primary/20 bg-black/30 p-4 ${dir === "rtl" ? "sm:flex-row-reverse" : ""}`}>
          <Button
            variant="outline"
